...
/**
 * Avril
 * Customizer Control: Avril Radio Image control
 */

class Avril_Customize_Control_Radio_Image extends Avril_Customize_Base_Control {
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="avril-radio-image-select">
