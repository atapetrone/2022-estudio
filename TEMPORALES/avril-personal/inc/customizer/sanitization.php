...
function avril_sanitize_sortable( $val = array(), $setting ) {
...
function avril_sanitize_typography_fonts( $input ) {
	$standard = avril_font_selector_get_standard_fonts();
	$google = avril_font_selector_get_google_fonts_array();
