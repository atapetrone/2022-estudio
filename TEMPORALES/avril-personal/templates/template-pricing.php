<?php 
/**
Template Name: Pricing Simple Page
*/
				...
				<div class="av-columns-area">
					<?php
						...
						foreach ( $pg_pricing_faq_content as $faq_item ) {
							...
							$avril_price_title = ! empty( $faq_item->title ) ? apply_filters( 'avril_translate_single_string', $faq_item->title, 'FAQ section' ) : '';
							$text = ! empty( $faq_item->text ) ? apply_filters( 'avril_translate_single_string', $faq_item->text, 'FAQ section' ) : '';
							$avril_price_link = ! empty( $faq_item->link) ? apply_filters( 'avril_translate_single_string', $faq_item->link,'FAQ section' ) : '';
					?>
						<div class="av-column-6 mb-4">
							<div class="faq-list">
								...
								<div class="faq-content">
									<?php if ( ! empty( $avril_price_title ) ) : ?>
										<h5><a href="<?php echo esc_url( $avril_price_link ); ?>"><?php echo esc_html( $avril_price_title ); ?></h5>
									<?php endif; ?>  
									<?php if ( ! empty( $text ) ) : ?>
