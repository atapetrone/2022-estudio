...
wp_enqueue_script('avril-style-picker-js', get_template_directory_uri() .'/inc/style-configurator/style_bundle/picker.js');
...
wp_enqueue_style('avril-style-configurator-css', get_template_directory_uri() .'/inc/style-configurator/style_bundle/style-configurator.css');

wp_enqueue_script('avril-style-configurator-js', get_template_directory_uri() .'/inc/style-configurator/style_bundle/style-configurator.js');

include( get_template_directory() . '/inc/style-configurator/colors.php');
?>
<style id="avrilCustomCss"></style>
<!--======================================
    Style Configurator
========================================-->
