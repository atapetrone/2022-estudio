<?php 
	...
	$settings=array('items'=>$testimonial_column);	
	wp_register_script('avril-testimonial',get_template_directory_uri().'/assets/js/homepage/testimonial.js',array('jquery'));
	wp_localize_script('avril-testimonial','testimonial_settings',$settings);
	wp_enqueue_script('avril-testimonial');	
?>
