<?php 
	...
	$feature_column				= get_theme_mod('feature_column','4');
?>
 <section id="features-section" class="features-section bg-primary av-py-default">
        <div class="av-container">
            ...
            <div class="av-columns-area features-area wow fadeInUp">
				...
				?>
					<div class="av-column-<?php echo esc_attr($feature_column); ?> av-md-column-6 mb-6">
						<div class="features-item">
							<div class="features-icon">
								<?php if ( ! empty( $image )  &&  ! empty( $icon )){ ?>
									<img class="services_cols_mn_icon" src="<?php echo esc_url( $image ); ?>" <?php if ( ! empty( $avril_features_title ) ) : ?> alt="<?php echo esc_attr( $avril_features_title ); ?>" title="<?php echo esc_attr( $avril_features_title ); ?>" <?php endif; ?> />
							...
							<div class="features-content">
								<?php if ( ! empty( $avril_features_title ) ) : ?>
									<h5 class="features-title"><a href="<?php echo esc_url( $avril_features_link ); ?>"><?php echo esc_html( $avril_features_title ); ?></a></h5>
								<?php endif; ?>
								<?php if ( ! empty( $text ) ) : ?>
