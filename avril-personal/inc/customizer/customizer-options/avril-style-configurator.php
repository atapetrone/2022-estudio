<?php
function avril_style_configurator( $wp_customize ) {
	...
	$wp_customize->add_panel( 
		...
		array(
			...
			'title'			=> __('Style Configurator', 'avril-pro'),
		) 
	);
	...
	$wp_customize->add_section(
        'page_layout',
        array(
            'title' 		=> __('Page Layout','avril-pro'),
            'description' 	=>'',
	...
	public $type = 'new_menu';
		   ...
		   {
		    echo '<h3>' .  __( 'Website Layout', 'avril-pro' ) . '</h3>';
	...
	'wide_boxed' , 
		array(
			'label'          => __( 'Select Page Layout', 'avril-pro' ),
			'section'        => 'page_layout',
			'type'           => 'radio',
			'description'    => __( 'Select Page Layout Wide & Boxed', 'avril-pro' ),
			'choices'        => 
			array(
				'wide' => 'wide.jpg',
				'boxed' => 'boxed.jpg',
	...
	'bg_pattern' , 
		array(
			'label'          => __( 'Preset Background Pattern', 'avril-pro' ),
			'section'        => 'page_layout',
			'type'           => 'radio',
			'description'    => __( 'Background Pattern will work only Boxed Page Layout', 'avril-pro' ),
			'choices'        => 
			array(
				'bg-img0.png' => 'sm0.png',
	...
	$wp_customize->add_section(
        'prebuilt_colors',
        array(
            'title' 		=> __('Prebuilt Theme Color','avril-pro'),
            'description' 	=>'',
			'panel'  		=> 'style_configurator',
		)
    );
	...
	public $type = 'new_menu';
		   ...
		   function render_content()
		   {
		   echo '<h3>' .  __( 'Select Your Prebuilt Theme Color', 'avril-pro' ) . '</h3>';
	...
	array(
        'label'   => __('Select Your Theme Color', 'avril-pro'),
	...
	$wp_customize->add_section(
        'make_theme',
        array(
            'title' 		=> __('Make Own Theme Color','avril-pro'),
			'panel'  		=> 'style_configurator',
		)
    );
	...
	'theme_color_enable', 
		array(
			'label'	      => esc_html__( 'Enable Custom Color', 'avril-pro' ),
			'section'     => 'make_theme',
			'type'        => 'checkbox'
		) 
	);
	...
	$wp_customize->add_control( 
		...
		($wp_customize, 
			'primary_color', 
			array(
				'label'      => __( 'Primary Theme Color', 'avril-pro' ),
				'section'    => 'make_theme',
	...
	$wp_customize->add_control( 
		...
		($wp_customize, 
			'secondary_color', 
			array(
				'label'      => __( 'Secondary Theme Color', 'avril-pro' ),
				'section'    => 'make_theme',
	...
	$wp_customize->add_section(
        'front_pallate',
        array(
            'title' 		=> __('Front Pallate','avril-pro'),
			'panel'  		=> 'style_configurator',
		)
    );
	...
	'front_pallate_enable', 
		array(
			'label'	      => esc_html__( 'This features for testing purpose, how it look website front before publishing', 'avril-pro' ),
...
add_action( 'customize_register', 'avril_style_configurator' );
?>