        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
					...
					'button_second': avrilescapeHtml(button_second),
                    'link2': link2,
...
jQuery(document).ready(function () {
    ...
    avril_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_avril_Service').val()>=4)
        {
	...
	avril_theme_controls.on('keyup', '.customizer-repeater-button2-control', function () {
        avril_customizer_repeater_refresh_general_control_values();
    });
	...
	avril_theme_controls.on('change','.customizer-repeater-checkbox', function(){
