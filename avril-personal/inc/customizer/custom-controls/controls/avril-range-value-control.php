 ...
 * @access public
 */
class Avril_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Avril_Customizer_Range_Control constructor.
	 *
 ...
 */
function avril_sanitize_range_value( $input ) {
	if ( avril_is_json( $input ) ) {
